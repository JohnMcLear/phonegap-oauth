 ...
 *  The idea is to provide an easy, fast and reliable OAuth authentication
 *  for HTML5 / PhoneGap apps with ChildBrowser and also support
 *  windows popups (offline development without the need of a phone/emulator).
 *	
